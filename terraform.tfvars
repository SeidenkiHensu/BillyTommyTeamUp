...
create_ec2_instances = false # Decides whether or not to create ec2 instances
active_env = "green" # Sets the stack we want to use between Blue and Green
create_alb = false # Decides whether or not to create an ALB if not it's not already created
