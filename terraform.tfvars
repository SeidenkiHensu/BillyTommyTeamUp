...
manage_alb           = true   # Decides whether or not to create an ALB if it's not already created
#environment          = "sandbox" # Sets the environment label for tagging and naming
